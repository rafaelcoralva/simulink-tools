function [axis_angles] = cardiac_max_s1p2p_axis_finder(avg_s1_xyz)
...
for el_mat = -90:1:90 % el_mat represents the elevation in the Matlab coordinate frame.
    for az_mat = -179:1:180 % az_mat represents the azimuthal angle in the Matlab coordinate frame.
        ...
        projection = zeros(size(avg_s1_xyz)); % Initializing for speed.
...
for el_mat = -90:1:90 % Considering the anterior hemisphere (only a single hemisphere needs to be considered as the p2p amplitude captures also the opposing hemisphere).
    for az_mat = -179:1:0
        ...
        s1_p_antipodal_sum_sph_mat(el_mat + 91, az_mat + 180) = s1_p_sph_mat(idx_el_mat, idx_az_mat) + s1_p_sph_mat(idx_antipodal_el_mat, idx_antipodal_az_mat);
...
[idx_max_s1_p2p_el_sph, idx_max_s1_p2p_az_sph] = find(s1_p_antipodal_sum_sph_mat == max_s1_p2p); % The row (elevation) and column (azimuth) indices of 's1_p_antipodal_sum_sph_mat' corresponding to the max s1 p2p (in the anterior hemisphere).
max_s1_p2p_el_sph_mat = idx_max_s1_p2p_el_sph - 91; % The actual elevation angle (in the Matlab reference frame) maximising S1 p2p.
max_s1_p2p_az_sph_mat = idx_max_s1_p2p_az_sph - 180; % The actual azimuthal angle (in the Matlab reference frame) maximising S1 p2p.
...
min_s1_p2p_el_sph_mat = idx_min_s1_p2p_el_sph - 91; % The actual elevation angle minimising S1 p2p. 
min_s1_p2p_az_sph_mat = idx_min_s1_p2p_az_sph - 180; % The actual azimuthal angle minimising S1 p2p.
...
hold on; plot3(idx_max_s1_p2p_az_sph, idx_max_s1_p2p_el_sph, max_s1_p2p,'r.','MarkerSize',30); legend('S1 P2P Amplitude', 'Max S1 P2P Amplitude')
...
hold on; plot3([s1_p_x_scg(idx_max_s1_p2p_el_sph, idx_max_s1_p2p_az_sph); s1_p_x_scg(max_s1_p2p_el_antipode_sph_idx, max_s1_p2p_az_antipode_sph_idx)],[s1_p_z_scg(idx_max_s1_p2p_el_sph, idx_max_s1_p2p_az_sph); s1_p_z_scg(max_s1_p2p_el_antipode_sph_idx, max_s1_p2p_az_antipode_sph_idx)],[s1_p_y_scg(idx_max_s1_p2p_el_sph, idx_max_s1_p2p_az_sph); s1_p_y_scg(max_s1_p2p_el_antipode_sph_idx, max_s1_p2p_az_antipode_sph_idx)],'r--','LineWidth',3);
hold on; plot3([s1_p_x_scg(idx_min_s1_p2p_el_sph, idx_min_s1_p2p_az_sph); s1_p_x_scg(min_s1_p2p_el_antipode_sph_idx, min_s1_p2p_az_antipode_sph_idx)],[s1_p_z_scg(idx_min_s1_p2p_el_sph, idx_min_s1_p2p_az_sph); s1_p_z_scg(min_s1_p2p_el_antipode_sph_idx, min_s1_p2p_az_antipode_sph_idx)],[s1_p_y_scg(idx_min_s1_p2p_el_sph, idx_min_s1_p2p_az_sph); s1_p_y_scg(min_s1_p2p_el_antipode_sph_idx, min_s1_p2p_az_antipode_sph_idx)],'b--','LineWidth',3); legend('S1 Acceleration Trajectory','S1 Peak Amplitude Projection','Max S1 p2p Axis','Min S1 p2p Axis');
clear hcb
...
max_distance = sqrt( (s1_p_x_scg(idx_max_s1_p2p_el_sph, idx_max_s1_p2p_az_sph) - s1_p_x_scg(max_s1_p2p_el_antipode_sph_idx, max_s1_p2p_az_antipode_sph_idx)).^2 + (s1_p_z_scg(idx_max_s1_p2p_el_sph, idx_max_s1_p2p_az_sph) - s1_p_z_scg(max_s1_p2p_el_antipode_sph_idx, max_s1_p2p_az_antipode_sph_idx)).^2 + (s1_p_y_scg(idx_max_s1_p2p_el_sph, idx_max_s1_p2p_az_sph) - s1_p_y_scg(max_s1_p2p_el_antipode_sph_idx, max_s1_p2p_az_antipode_sph_idx)).^2 );
min_distance = sqrt( (s1_p_x_scg(idx_min_s1_p2p_el_sph, idx_min_s1_p2p_az_sph) - s1_p_x_scg(min_s1_p2p_el_antipode_sph_idx, min_s1_p2p_az_antipode_sph_idx)).^2 + (s1_p_z_scg(idx_min_s1_p2p_el_sph, idx_min_s1_p2p_az_sph) - s1_p_z_scg(min_s1_p2p_el_antipode_sph_idx, min_s1_p2p_az_antipode_sph_idx)).^2 + (s1_p_y_scg(idx_min_s1_p2p_el_sph, idx_min_s1_p2p_az_sph) - s1_p_y_scg(min_s1_p2p_el_antipode_sph_idx, min_s1_p2p_az_antipode_sph_idx)).^2 );


%% Converting the function output angles into the SCG reference frame.
max_s1_p2p_el = max_s1_p2p_el_sph_mat;
max_s1_p2p_az = -1*max_s1_p2p_az_sph_mat;
min_s1_p2p_el = min_s1_p2p_el_sph_mat;
min_s1_p2p_az = -1*min_s1_p2p_az_sph_mat;

clear max_s1_p2p_el_sph_mat max_s1_p2p_az_sph_mat min_s1_p2p_el_sph_mat min_s1_p2p_az_sph_mat

max_s1_p2p_angles = [max_s1_p2p_el, max_s1_p2p_az];
min_s1_p2p_angles = [min_s1_p2p_el, min_s1_p2p_az];

axis_angles = [max_s1_p2p_angles, min_s1_p2p_angles]; % The output of the function is the max S1 elevation and azimuth angles and the min S1 elevation and azimuth angles in the SCG reference frame.
end
